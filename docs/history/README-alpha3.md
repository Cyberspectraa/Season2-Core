...
The courier now uses directional front service points for postal blocks, retries front-corner approaches when stuck, slows down for box interactions, and includes a ready-to-import EasyNPC courier preset with operator-safe binding.
